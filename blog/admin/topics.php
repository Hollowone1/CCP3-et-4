...
<?php $topics = getAllTopics();	?>
	<title>Admin | Gérer les topics</title>
</head>
<body>
	<!-- admin navbar -->
	...
	<div class="container content">
		...
		<div class="action">
			<h1 class="page-title">Créer/Editer les topics</h1>
			<form method="post" action="<?php echo BASE_URL . 'admin/topics.php'; ?>" >
				...
				<?php else: ?>
					<button type="submit" class="btn" name="create_topic">Sauvegarder les topics</button>
				<?php endif ?>
			</form>
		</div>
		<!-- // Middle form - to create and edit -->
		...
		<div class="table-div">
			...
			<?php if (empty($topics)): ?>
				<h1>Pas de topics dans la base de donnée</h1>
			<?php else: ?>
				<table class="table">
					<thead>
						<th>N</th>
